...
//		3) Retrieve a limited number of products.1
		@Test
...
public void testAddNewProduct() {
	Product newProduct=Payload.payloadProduct();
	...
	.then()
		...
		.log().all()
		.extract().jsonPath().getInt("id"); //Extracting Id from response bod
//		.log().all();
}
...
public void testUpdateProduct()
{
	...
	Product updatedPayload=Payload.payloadProduct();
